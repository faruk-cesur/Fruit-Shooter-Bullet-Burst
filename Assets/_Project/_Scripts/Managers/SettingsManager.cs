...
public class SettingsManager : Singleton<SettingsManager>
{
    ...
    // {
    //     _gameplayData.BulletDamage = BulletDamageSlider.value;
    //     _gameplayData.BulletReloadDuration = BulletReloadDurationSlider.value;
    //     _gameplayData.CollectedFruitBonus = (int)FruitCollectBonusSlider.value;
